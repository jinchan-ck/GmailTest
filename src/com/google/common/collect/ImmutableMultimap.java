  ...
  implements Multimap<K, V>, Serializable
{
  ...
  public static <K, V> ImmutableMultimap<K, V> copyOf(Multimap<? extends K, ? extends V> paramMultimap)
  {
    if ((paramMultimap instanceof ImmutableMultimap))
      return (ImmutableMultimap)paramMultimap;
  ...
  public ImmutableCollection<Map.Entry<K, V>> entries()
  {
    ...
    {
      EntryCollection localEntryCollection = new EntryCollection(this);
      this.entries = localEntryCollection;
      return localEntryCollection;
    }
  ...
  {
    ImmutableMultiset localImmutableMultiset1 = this.keys;
    if (localImmutableMultiset1 == null)
    {
      ImmutableMultiset localImmutableMultiset2 = createKeys();
      this.keys = localImmutableMultiset2;
      return localImmutableMultiset2;
    }
  ...
  {
    private final Multimap<K, V> builderMultimap = new ImmutableMultimap.BuilderMultimap();
  ...
  private static class Values<V> extends ImmutableCollection<V>
  {
    ...
    Values(Multimap<?, V> paramMultimap)
    {
