...
public final class Booleans
{
  ...
  public static boolean[] ensureCapacity(boolean[] paramArrayOfBoolean, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfBoolean.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfBoolean, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfBoolean;
  }
  ...
  public static boolean[] toArray(Collection<Boolean> paramCollection)
  {
    ...
    for (int j = 0; j < i; j++)
      arrayOfBoolean[j] = ((Boolean)arrayOfObject[j]).booleanValue();
    return arrayOfBoolean;
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Boolean set(int paramInt, Boolean paramBoolean)
    {
      ...
      this.array[(paramInt + this.start)] = paramBoolean.booleanValue();
