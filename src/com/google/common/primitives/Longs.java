...
public final class Longs
{
  ...
  public static long[] ensureCapacity(long[] paramArrayOfLong, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfLong.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfLong, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfLong;
  }
  ...
  public static long fromByteArray(byte[] paramArrayOfByte)
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      return (0xFF & paramArrayOfByte[0]) << 56 | (0xFF & paramArrayOfByte[1]) << 48 | (0xFF & paramArrayOfByte[2]) << 40 | (0xFF & paramArrayOfByte[3]) << 32 | (0xFF & paramArrayOfByte[4]) << 24 | (0xFF & paramArrayOfByte[5]) << 16 | (0xFF & paramArrayOfByte[6]) << 8 | 0xFF & paramArrayOfByte[7];
    }
  }
  ...
  public static long[] toArray(Collection<Long> paramCollection)
  {
    ...
    for (int j = 0; j < i; j++)
      arrayOfLong[j] = ((Long)arrayOfObject[j]).longValue();
    return arrayOfLong;
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Long set(int paramInt, Long paramLong)
    {
      ...
      this.array[(paramInt + this.start)] = paramLong.longValue();
