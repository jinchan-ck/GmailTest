...
public final class Chars
{
  ...
  public static char[] ensureCapacity(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfChar.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfChar, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfChar;
  }
  ...
  public static char fromByteArray(byte[] paramArrayOfByte)
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      return (char)(paramArrayOfByte[0] << 8 | 0xFF & paramArrayOfByte[1]);
    }
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Character set(int paramInt, Character paramCharacter)
    {
      ...
      this.array[(paramInt + this.start)] = paramCharacter.charValue();
