...
public final class Bytes
{
  ...
  public static byte[] ensureCapacity(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfByte.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfByte, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfByte;
  }
  ...
  public static byte[] toArray(Collection<Byte> paramCollection)
  {
    ...
    for (int j = 0; j < i; j++)
      arrayOfByte[j] = ((Byte)arrayOfObject[j]).byteValue();
    return arrayOfByte;
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Byte set(int paramInt, Byte paramByte)
    {
      ...
      this.array[(paramInt + this.start)] = paramByte.byteValue();
