...
public final class Doubles
{
  ...
  public static double[] ensureCapacity(double[] paramArrayOfDouble, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfDouble.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfDouble, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfDouble;
  }
  ...
  public static double[] toArray(Collection<Double> paramCollection)
  {
    ...
    for (int j = 0; j < i; j++)
      arrayOfDouble[j] = ((Double)arrayOfObject[j]).doubleValue();
    return arrayOfDouble;
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Double set(int paramInt, Double paramDouble)
    {
      ...
      this.array[(paramInt + this.start)] = paramDouble.doubleValue();
