...
public final class Floats
{
  ...
  public static float[] ensureCapacity(float[] paramArrayOfFloat, int paramInt1, int paramInt2)
  {
    ...
    label77: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      if (paramArrayOfFloat.length >= paramInt1)
        break label83;
      return copyOf(paramArrayOfFloat, paramInt1 + paramInt2);
      bool1 = false;
      break;
    }
    label83: return paramArrayOfFloat;
  }
  ...
  public static float[] toArray(Collection<Float> paramCollection)
  {
    ...
    for (int j = 0; j < i; j++)
      arrayOfFloat[j] = ((Float)arrayOfObject[j]).floatValue();
    return arrayOfFloat;
  }
    ...
    implements RandomAccess, Serializable
  {
    ...
    public Float set(int paramInt, Float paramFloat)
    {
      ...
      this.array[(paramInt + this.start)] = paramFloat.floatValue();
