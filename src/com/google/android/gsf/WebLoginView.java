...
public class WebLoginView
{
  ...
  public static enum Error
  {
    static
    {
      ...
      arrayOfError[0] = HttpError;
      arrayOfError[1] = TooManyRedirects;
    }
  }
  ...
  private class MyWebViewClient extends WebViewClient
  {
    ...
    public void onPageFinished(WebView paramWebView, String paramString)
    {
      ...
      if (!maybeFinish(paramWebView))
      {
        ...
        String str1 = "";
        if ("https".equalsIgnoreCase(localUri.getScheme()))
          str1 = str1 + "https://";
        String str2 = WebLoginView.this.mWebView.getTitle();
        if (TextUtils.isEmpty(str2));
        for (String str3 = str1 + localUri.getAuthority(); ; str3 = str1 + localUri.getAuthority() + " : " + str2)
        {
          WebLoginView.this.mTitleTextView.setText(str3);
 ...
 * Qualified Name:     com.google.android.gsf.WebLoginView
