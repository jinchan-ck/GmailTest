...
public abstract interface MailStore
{
  ...
  public static class CustomFromPreference
  {
    ...
    public CustomFromPreference(String paramString1, String paramString2, String paramString3, String paramString4)
    {
      ...
      this.replyTo = paramString4;
      this.isDefault = paramString3;
    }
  }
  ...
  public static class LabelInfo
  {
    ...
    {
      this.canonicalName = paramString1;
      this.name = paramString2;
      this.numConversations = paramInt1;
      this.numUnreadConversations = paramInt2;
      this.color = paramInt3;
      this.visibility = paramString3;
    }
  }
