...
public class HtmlParser
{
  ...
  public HtmlParser(ParseStyle paramParseStyle)
  {
    ...
    for (boolean bool1 = true; ; bool1 = false)
    {
      ...
      if (!this.preserveAll)
      {
        ParseStyle localParseStyle = ParseStyle.PRESERVE_VALID;
        bool2 = false;
        if (paramParseStyle != localParseStyle);
      }
      else
      {
        bool2 = true;
  ...
  private void addEndTag(HTML.Element paramElement, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      bool2 = false;
      break;
      label115: bool3 = false;
      break label33;
      label121: bool4 = false;
      break label57;
      label127: bool1 = false;
    }
    label133: if (this.preserveValidHtml)
    {
      StringBuilder localStringBuilder = new StringBuilder("</");
      boolean bool5;
      if (paramInt1 < paramInt2)
  ...
  public HtmlDocument parse(String paramString)
  {
    ...
    if ((k < i) && (!this.clipped))
    {
      int m;
      boolean bool5;
      switch (1.$SwitchMap$com$google$android$common$html$parser$HtmlParser$State[this.state.ordinal()])
      {
      default:
  ...
  {
    HTML.Element localElement = ((HtmlDocument.Tag)this.nodes.get(-1 + this.nodes.size())).getElement();
    boolean bool;
  ...
  int scanTag(int paramInt1, int paramInt2)
  {
    ...
    int i3;
    char c;
    label258: boolean bool4;
    label272: String str2;
    String str3;
    if (m < paramInt2)
    {
      i3 = m;
    ...
    while (true)
    {
      ...
      return paramInt2;
      label318: localElement = lookupElement(str1);
      if (localElement != null)
        break;
      if (DEBUG)
      ...
      label548: for (boolean bool7 = true; ; bool7 = false)
      {
        X.assertTrue(bool7);
        break;
      ...
      label554: bool4 = false;
      break label272;
      label560: boolean bool5 = this.preserveValidHtml;
      str3 = null;
      if (bool5)
        str3 = CharMatcher.is('<').replaceFrom(this.html.substring(paramInt1, paramInt2), "&lt;");
    }
    label598: boolean bool3;
    int i2;
    if (this.html.charAt(m) == '>')
    {
      ...
      if (localElement != null)
      {
        if (k == 0)
          break label656;
        addEndTag(localElement, paramInt1, n, i2);
      }
    }
    while (true)
    {
      ...
      bool3 = false;
      break;
      label656: if ((HTML4.SCRIPT_ELEMENT.equals(localElement)) || (HTML4.STYLE_ELEMENT.equals(localElement)))
        this.state = State.IN_CDATA;
      addStartTag(localElement, paramInt1, n, i1, i2, bool2, localArrayList);
    }
  }
  ...
  private static class AttributeScanner
  {
    ...
    int scanValue(int paramInt1, int paramInt2)
    {
      ...
      boolean bool2;
      label147: boolean bool3;
      label163: boolean bool4;
      if ((k == 39) || (k == 34))
      {
        this.attrValueIsQuoted = bool1;
        j++;
        int m = j;
 ...
 * Qualified Name:     com.google.android.common.html.parser.HtmlParser
