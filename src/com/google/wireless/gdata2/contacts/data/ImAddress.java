...
public class ImAddress extends ContactsElement
{
  ...
  public ImAddress(String paramString1, byte paramByte1, String paramString2, byte paramByte2, String paramString3, boolean paramBoolean)
  {
    super(paramByte2, paramString3, paramBoolean);
    this.address = paramString1;
    this.protocolPredefined = paramByte1;
    this.protocolCustom = paramString2;
  }
 ...
 * Qualified Name:     com.google.wireless.gdata2.contacts.data.ImAddress
