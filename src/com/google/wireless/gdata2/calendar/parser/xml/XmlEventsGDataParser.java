...
public class XmlEventsGDataParser extends XmlGDataParser
{
    ...
    throws XmlPullParserException, IOException, ParseException
  {
    ...
    String str6;
    byte b3;
    if (XmlUtils.matchNameSpaceUri(localXmlPullParser, GD_NAMESPACE))
    ...
    do
    {
      ...
      while (!XmlUtils.matchNameSpaceUri(localXmlPullParser, GCAL_NAMESPACE));
    ...
    while (!"guestsCanSeeGuests".equals(str1));
 ...
 * Qualified Name:     com.google.wireless.gdata2.calendar.parser.xml.XmlEventsGDataParser
