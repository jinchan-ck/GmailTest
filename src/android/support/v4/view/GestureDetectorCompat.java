    ...
    implements GestureDetectorCompat.GestureDetectorCompatImpl
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      case 2:
        ...
        return bool5;
      case 1:
        label639: this.mStillDown = false;
        label844: label871: MotionEvent localMotionEvent = MotionEvent.obtain(paramMotionEvent);
        boolean bool2;
        if (this.mIsDoubleTapping)
    ...
    private class GestureHandler extends Handler
    {
      ...
      public void handleMessage(Message paramMessage)
      {
        ...
        while ((GestureDetectorCompat.GestureDetectorCompatImplBase.this.mDoubleTapListener == null) || (GestureDetectorCompat.GestureDetectorCompatImplBase.this.mStillDown));
