...
public class ViewPager extends ViewGroup
{
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      label340: for (float f4 = this.mInitialMotionX + this.mTouchSlop; ; f4 = this.mInitialMotionX - this.mTouchSlop)
      {
  ...
  void populate(int paramInt)
  {
    ...
    if (this.mAdapter == null)
      break label33;
    label33: label230: label1002: label1134: 
    while (true)
    {
      return;
      if ((!this.mPopulatePending) && (getWindowToken() != null))
      {
        ...
        if (i1 < i2)
        {
          ...
          if (localItemInfo8.position < this.mCurItem)
            break label549;
          int i17 = localItemInfo8.position;
        ...
        if (localObject1 != null)
        {
          ...
          if (i8 >= 0)
          {
            localItemInfo5 = (ItemInfo)this.mItems.get(i8);
        ...
        while (true)
        {
          ...
          localItemInfo5 = null;
          break label230;
          int i16 = localItemInfo5.position;
          if ((i9 == i16) && (!localItemInfo5.scrolling))
          {
          ...
          for (localItemInfo5 = (ItemInfo)this.mItems.get(i8); ; localItemInfo5 = null)
          {
            i9--;
            break;
          }
          if (localItemInfo5 != null)
          {
            int i15 = localItemInfo5.position;
            if (i9 == i15)
            {
          ...
          int i14 = i8 + 1;
          f1 += addNewItem(i9, i14).widthFactor;
          i1++;
          if (i8 >= 0);
          for (localItemInfo5 = (ItemInfo)this.mItems.get(i8); ; localItemInfo5 = null)
            break;
          label766: localItemInfo6 = null;
          break label318;
          int i13 = localItemInfo6.position;
          if ((i11 == i13) && (!localItemInfo6.scrolling))
          {
            this.mItems.remove(i10);
            PagerAdapter localPagerAdapter2 = this.mAdapter;
            Object localObject3 = localItemInfo6.object;
            localPagerAdapter2.destroyItem(this, i11, localObject3);
            if (i10 >= this.mItems.size())
              break label859;
          }
          ...
          if (localItemInfo6 != null)
          {
            int i12 = localItemInfo6.position;
            if (i11 == i12)
            {
          ...
          ItemInfo localItemInfo7 = addNewItem(i11, i10);
          i10++;
